...
public class ProgramReport {
    ...
    public static Workbook generateProgram(Workbook wb, ReportEntity report, Map<String, String> param) {
        ...
        if (type_of_work.contains(TypeOfWork.MetallicBond)){
            ...
            list.add("ПТЭЭП табл. 28.5, ГОСТ Р 50571.5.54-2013, ПУЭ 1.8.39 п.2.");
        ...
        if (type_of_work.contains(TypeOfWork.Insulation)){
            ...
            list.add("ПУЭ п.1.8.37; ПТЭЭП прил. 3.1, табл. 37; ГОСТ Р 50571.16-2019");
        ...
        if (type_of_work.contains(TypeOfWork.PhaseZero)){
            ...
            list.add("ПУЭ п.1.7.79; ПУЭ: п.1.8.39; ПТЭЭП прил.3 п.28.4; ГОСТ Р 50571.4.43-2012; ГОСТ Р 50571.5.54-2013");
        ...
        if (type_of_work.contains(TypeOfWork.Grounding)){
            ...
            list.add("ПУЭ: 1.7.100-1.7.102, ПУЭ: 1.8.39; ПТЭЭП п.26.4.2; ПТЭЭП п.2.7.10; ПТЭЭП п.2.7.12");
        ...
        if (type_of_work.contains(TypeOfWork.Avtomat)){
            ...
            list.add("Электрооборудование");
            list.add("Проверка расцепителя автоматического выключателя");
            list.add("ПУЭ: 1.8.37 п.3; ПУЭ: 3.1.8; ПУЭ: 1.7.79; ПУЭ: 7.3.139; ПУЭ: 1.8.34. п.3.; ГОСТ IEC 60898-1-2020, ГОСТ Р 50030.2-2010, ГОСТ Р 50571.4.43-2012");
